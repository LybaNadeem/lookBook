        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              TextField(
                controller: dressTitleController, // Controller for Description
                decoration: InputDecoration(
                  hintText: 'Type',
              ...
              TextField(
                controller:
                    projectDescriptionController, // Controller for Description
              ...
              TextField(
                controller:
                    minimumorderController, // Controller for Minimum Order
                decoration: InputDecoration(
              ...
              SizedBox(height:height * 0.010),
              TextField(
                controller: instagramController, // Controller for Description
                // Multi-line input
                decoration: InputDecoration(
                  hintText: 'Link',
                  hintStyle: TextStyle(fontFamily: 'TenorSans',color: Colors.grey[400], fontSize: 14),
              ...
              SizedBox(height:height * 0.010),
              TextField(
                controller: linkedinController, // Controller for Description
                // Multi-line input
                decoration: InputDecoration(
                  hintText: 'Link',
                  hintStyle: TextStyle(fontFamily: 'TenorSans',color: Colors.grey[400], fontSize: 14),
                              ...
                              children: [
                                ...
                                TextField(
                                  decoration: InputDecoration(
                                    ...
                                    hintText: 'Title', // Placeholder text for the text field
                                    hintStyle: TextStyle(
                                      fontFamily: 'TenorSans',
                                      color: Colors.grey.shade400, // Light gray hint text
                                    ),
                                ...
                                TextField(
                                  decoration: InputDecoration(
                                    ...
                                    hintText: 'Link', // Placeholder text for the text field
                                    hintStyle: TextStyle(
                                      color: Colors.grey.shade400, // Light gray hint text
                                    ),
                                  ),
...
// Add other widgets here, buttons, etc.
              ...
              SizedBox(height:height * 0.010),
              TextField(
                controller: BarcodeController, // Controller for Description
                // Multi-line input
                decoration: InputDecoration(
                  hintText: '023 ATYGH 7138',
                  hintStyle: TextStyle(fontFamily: 'TenorSans',color: Colors.grey[400], fontSize: 14),
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(30),
                  ),
              ...
              SizedBox(height:height * 0.010),
              TextField(
                controller: EventController, // Controller for Description
                // Multi-line input
                decoration: InputDecoration(
                  hintText: 'Event',
                  hintStyle: TextStyle(fontFamily: 'TenorSans',color: Colors.grey[400], fontSize: 14),
              ...
              SizedBox(height:height * 0.010),
              TextField(
                controller: EventdateController, // Controller for Description
                // Multi-line input
                decoration: InputDecoration(
                  hintText: 'Event Date',
                  hintStyle: TextStyle(fontFamily: 'TenorSans',color: Colors.grey[400], fontSize: 14),
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  // Navigate to AddPhotographer.dart
                  Navigator.push(
                    context,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SvgPicture.asset(
                      'assets/icons/arrow_icon.svg', // Update with your SVG path
                      width: width * 0.015,
                      height: height * 0.015,
                    ),
                  ],
