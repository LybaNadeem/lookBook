...
import 'CustomerMessage_screen.dart';
...
class CustomerHomePage extends StatefulWidget {
  ...
  CustomerHomePage({Key? key, required this.productId}) : super(key: key);
  @override
  ...
  void onTabTapped(int index) {
    ...
    if (index == 1) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => CustomermessageScreen(currentUserId: '',),
        ),
      );
    } else if (index == 3) {
      Navigator.push(
                      ...
                      ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => CustomerHomePage(productId:widget.productId),
                            ),
                          );
                        },
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => ProductdetailScreen(
                            productId: product['productId'], designerId: product['userId'], SenderId: '', // Assuming `id` exists in your `product` map
                            // Pass photographerId if available
                          ),
                        ),
                      );
                    },
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: (product['imageList'] != null && product['imageList'].isNotEmpty)
                                  ? NetworkImage(product['imageList'][0] as String)
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                product['DressTitle'] ?? "Unknown Product",
            ...
            Stack(
              children: [
                Container(
                  ...
                  width: double.infinity, // Adjust the width of the container
                ),
                Positioned(
