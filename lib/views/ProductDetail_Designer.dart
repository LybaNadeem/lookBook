...
class ProductdetailDesigner extends StatefulWidget {
  var productId;
  var photographerId;

ProductdetailDesigner({Key? key, required this.productId, required this.photographerId}) : super(key: key);
  @override
  _ProductdetailDesignerState createState() => _ProductdetailDesignerState();
}

class _ProductdetailDesignerState extends State<ProductdetailDesigner> {
      ...
      children: [
        Container(
          ...
          child: ElevatedButton(
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => ProductPreviewStateful (productId:widget.productId, photographerId: widget.photographerId,)));
            },
            style: ElevatedButton.styleFrom(
