...
class CustomerDetailScreen extends StatefulWidget {
  ...
  CustomerDetailScreen({required this.userId, required this.index});
...
class _CustomerDetailScreenState extends State<CustomerDetailScreen> {
  ...
  void initState() {
    super.initState();
    _fetchCustomerData(); // Fetch data when screen is initialized
  }
  ...
  Future<void> _fetchCustomerData() async {
    try {
      ...
      if (doc.exists) {
        setState(() {
          customerData = doc.data(); // Store fetched data in a state variable
        });
      }
    } catch (error) {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: NetworkImage(customerData!['profileImage'] ?? ''),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
              ...
              _buildContactInfoSection('Phone', customerData!['phone'] ?? '', 'assets/icons/phone.svg'),
              SizedBox(height: 10),
              _buildContactInfoSection('Email', customerData!['email'] ?? '', 'assets/icons/Message.svg'),
              SizedBox(height: 10),
