                    ...
                    children: [
                        ...
                        children: [
                          CircleAvatar(
                            backgroundImage: AssetImage(
                                'assets/images/Designer circle.png'), // Designer Image
                          ),
                          SizedBox(width: 10),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      Column(
                        ...
                        children: [
                          Container(
                            height:
                                58, // Set the desired height for the Edit button
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          Edit()), // Navigate to EditPage
                                );
                              },
                              style: ElevatedButton.styleFrom(
                                backgroundColor: Color(
                                    0xFFE47F46), // Button background color
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  SizedBox(width: 220),
                                  SvgPicture.asset(
                                    'assets/icons/edit.svg', // Path to the edit SVG icon
                                    width: 20,
                                    height: 20,
                                  ),
                                ],
                          ...
                          Container(
                            height:
                                80, // Set the desired height for the Edit button
                            width: double.infinity, // Full width
                            child: Padding(
                              ...
                              child: ElevatedButton(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    ...
                                    color: Color(0xFFE47F46), // Text color
                                    fontWeight: FontWeight.bold,
