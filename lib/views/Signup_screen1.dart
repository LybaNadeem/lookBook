            ...
            Center(
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    // Replace with the actual UserID fetched from Firebase Auth or local storage
                    String userId = "sDl8DYgRX3SHQYTXbhftOxNBR1W2";

                    try {
                      // Save UserID as Designer role in Firebase Firestore
                      await FirebaseFirestore.instance
                          .collection('users') // Your Firebase collection
                          .doc(userId) // User's document ID
                          .update({'role': 'Designer'}); // Update role field
                      print('Role updated to Designer successfully');
                    } catch (e) {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => SignupScreen(role: 'Designer'), // Pass role to the next screen
                      ),
                    );
                  },
